...
func TestWettkampfdefinitionsliste_AddElementSingle(t *testing.T) {
	var w = Wettkampfdefinitionsliste{}
	var e = elements.Veranstalter{Name: "Mario"}
	w.AddElement(e)
	assert.Equal(t, "Mario", w.Veranstalter.Name)
}

func TestWettkampfdefinitionsliste_AddElementArray(t *testing.T) {
	var w = Wettkampfdefinitionsliste{}
